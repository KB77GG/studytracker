...
## 2026-08-10 词汇 v2 真机音频 / 输入 / 品牌色热修（本地待发布）
...
- 当前 HEAD `233b9297`，生产仍为后端 `21398163` + 小程序 `16.0.74`；本轮代码/文档仅本机可见，未 commit/push/deploy/upload。
  下一步需明确授权后先部署兼容后端，再由用户发布小程序热修版并做 iPhone 静音键、自动播、重播、中文选项/英文严格键盘真机验收。
