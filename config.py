...
class Config:
    ...
    # 课堂模式口令：老师上课进入刷题库的轻量门禁，验证通过后写长效 cookie
    CLASSROOM_PASSCODE = os.environ.get("CLASSROOM_PASSCODE", "5188")
    ...
    WECHAT_COURSE_TEMPLATE_ID = os.environ.get(
        ...
        "AehPa5pMUTnQqXgq-q-wxTAMZyVU-qdkxaO9rbpo-QI",
    )
    ...
    PIPER_TTS_NOISE_SCALE = os.environ.get("PIPER_TTS_NOISE_SCALE", "")
    ...
    KOKORO_TTS_AUTO_DOWNLOAD = os.environ.get("KOKORO_TTS_AUTO_DOWNLOAD", "0")
    DICTATION_TTS_REPEAT_COUNT = os.environ.get("DICTATION_TTS_REPEAT_COUNT", "1")
    DICTATION_TTS_PROVIDER_TIMEOUT = os.environ.get("DICTATION_TTS_PROVIDER_TIMEOUT", "8")
    ...
    TENCENT_SOE_WS_HOST = os.environ.get("TENCENT_SOE_WS_HOST", "soe.cloud.tencent.com")
    TENCENT_SOE_ENGINE_MODEL_TYPE = os.environ.get("TENCENT_SOE_ENGINE_MODEL_TYPE", "16k_en")
    TENCENT_SOE_SSL_VERIFY = os.environ.get("TENCENT_SOE_SSL_VERIFY", "1")
    TENCENT_SOE_VOICE_ENCODE_TYPE = os.environ.get("TENCENT_SOE_VOICE_ENCODE_TYPE", "1")
