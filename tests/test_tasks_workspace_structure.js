...
test('tasks workspace exposes real navigation assets and responsive behaviors', () => {
  ...
  assert.match(finalCss, /min-height:106px !important/)
  assert.match(finalCss, /min-height:46px !important/)
  assert.match(finalCss, /grid-template-rows:46px !important/)
  assert.match(finalCss, /min-height:40px !important/)
  ...
  assert.match(finalCss, /height:clamp\(460px, calc\(100vh - 564px\), 500px\) !important/)
