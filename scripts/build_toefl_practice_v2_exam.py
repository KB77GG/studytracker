...
A27_EXAM_CONFIG: dict[str, Any] = {
    ...
    "EXAM_VARIANT": "A",
    "PROGRESS_NOTES": "120 atomic questions rebuilt from source; Listening M1 Q1/M1 Q2/M2 Q1 options were visually recovered from rendered source pages.",
    "BLOCKING_REASONS": [],
    ...
    "QA_CHECK_SPECS": [
        ...
        {"id": "listening-source", "status": "pass", "detail": "Listening M1 Q1/M1 Q2/M2 Q1 options were visually recovered from rendered source pages."},
        {"id": "media", "status": "pass", "detail": "Listening and speaking audio files exist and have readable ffprobe durations."},
...
B28_EXAM_CONFIG: dict[str, Any] = {
    ...
    "EXAM_DATE": "2026-01-28",
    "EXAM_VARIANT": "B",
    "PROGRESS_NOTES": "120 atomic questions rebuilt directly from B-volume PDF/audio/transcript sources; all source-visible items and answer mappings pass validation.",
    "BLOCKING_REASONS": [],
    "LATEST_BLOCKER_TEXT": "No unresolved source blockers in this package.",
    "QA_CHECK_SPECS": [
        {"id": "atomic-count", "status": "pass", "detail": "120 expected atomic questions are represented."},
        {"id": "answer-separation", "status": "pending", "detail": "Validator will check public content for answer leakage."},
        {"id": "reading-source", "status": "pass", "detail": "Reading content was recovered from rendered raw PDF pages, including documented OCR-number repair."},
